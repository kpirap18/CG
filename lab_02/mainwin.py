...
class Ui_Kozlova_lab_02(object):
    def setupUi(self, Kozlova_lab_02):
        ...
        self.lineEdit_modex.setGeometry(QtCore.QRect(50, 90, 101, 31))
        self.lineEdit_modex.setObjectName("lineEdit_modex")
        self.lineEdit_modey = QtWidgets.QLineEdit(self.mode)
        self.lineEdit_modey.setGeometry(QtCore.QRect(240, 90, 101, 31))
        ...
        self.label_centermode_3.setGeometry(QtCore.QRect(40, 50, 271, 31))
        ...
        self.label_xm.setGeometry(QtCore.QRect(40, 130, 55, 21))
        self.label_xm.setObjectName("label_xm")
        self.label_ym = QtWidgets.QLabel(self.scale)
        self.label_ym.setGeometry(QtCore.QRect(210, 130, 55, 31))
        ...
        self.label.setGeometry(QtCore.QRect(420, 80, 611, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, Kozlova_lab_02):
        ...
        self.label_dx.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">dx</span></p></body></html>"))
        self.label_dy.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">dy</span></p></body></html>"))
        self.pushButton_mode.setText(_translate("Kozlova_lab_02", "Перенести"))
        ...
        self.label_xm.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">Xm</span></p></body></html>"))
        self.label_ym.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">Ym</span></p><p><br/></p></body></html>"))
        ...
        self.label_ky.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">ky</span></p></body></html>"))
        self.label_kx.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">kx</span></p></body></html>"))
        ...
        self.label_yturn.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">y</span></p></body></html>"))
        self.label_xturn.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">x</span></p></body></html>"))
        self.info.setTitle(_translate("Kozlova_lab_02", "Центр Фигуры"))
        self.label_centerx.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">x</span></p></body></html>"))
        self.label_centery.setText(_translate("Kozlova_lab_02", "<html><head/><body><p><span style=\" font-size:12pt;\">y</span></p></body></html>"))
